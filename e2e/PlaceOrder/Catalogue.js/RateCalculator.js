...
describe("Placeorder/Catalogue/SingleNormalOrder/Discountfunctionality", function () {
  ...
  it("cod order", function () {
    cy.get(
      ".Flexbox_align-top__Nx4Aj > :nth-child(1) > .rs-flex-box-grid-item > .Input_input-group__c6y0f > .rs-input"
    ).type("700019");
    cy.get(
      ":nth-child(2) > .rs-flex-box-grid-item > .Input_input-group__c6y0f > .rs-input"
    ).type("560103");
    cy.get(
      ".Flexbox_align-middle__-J0b5.Flexbox_mt-lg__HQln6 > .rs-flex-box-grid-item-9 > .rs-flex-box-grid-item > .Input_input-group__c6y0f > .rs-input"
    ).type("1");
    cy.get(
    ...
    cy.get(
      ".rs-flex-box-grid-item-0 > .Input_input-group__c6y0f > .rs-input"
    ).type("17.1");
    cy.get(
