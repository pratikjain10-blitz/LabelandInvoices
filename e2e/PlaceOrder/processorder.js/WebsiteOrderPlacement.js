...
describe("CODorderFlow", function () {
  ...
  it("OnlineOrderFlow", function () {
    cy.visit("https://rudra.nushop.kaip.in/");
    cy.get(":nth-child(2) > .css-12d75xc > .css-1tu2nel").click();
    cy.get(".css-1vw8438").type("7908961320");
    cy.get(".css-2f3j1g").click();
    cy.get(".css-tpv9t0").each(($e1, index, list) => {
    ...
    cy.get(".css-kkzpvp")
      .clear()
      .type("Dinhataaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
    cy.wait(4000);
    cy.get(".css-2f3j1g").click();
    cy.get(".css-1vw8438").type("7908961320");
    ...
    cy.frameLoaded(
      'iframe[src*="build=cb850e58728544627e8920f7b82be79710058421"]'
    );
    cy.iframe()
      .get('label[class="radio-label mfix svelte-eyjg1z"]')
      .eq(1)
      .click();
