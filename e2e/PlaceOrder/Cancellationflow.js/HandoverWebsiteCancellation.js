...
for (let i = 0; i < 10; i++) {
  describe("duplicateOrderflow", function () {
    ...
    it("NONduplicateOrderflow", function () {
      ...
      cy.wait(5000).then(() => {
        ...
        cy.get(".rs-btn-toolbar > .Button_button-ghost__rieSu")
          ...
          .click()
          .then(() => {
            cy.get('div[class="HandoverChildViewCard_card__6hKXd"]')
              .eq(0)
              .then(() => {
    ...
    it("CancelWebsiteflow", function () {
      cy.visit("https://pratikj.nushop.kaip.in/");
      cy.wait(4000);
      ...
      cy.get(".css-2f3j1g").click();
      cy.wait(5000);
      let link = "https://pratikj.nushop.kaip.in/orders/";
      cy.log(web_cancel);
      ...
      cy.wait(2000);
      cy.get("#found_better_product_on_another_website")
        .click()
        .then(() => {
          ...
          .each(($p1, number, $queue) => {
            cy.get('div[class="PrintPackViewCard_card-border__Qk1I3"]')
              ...
              .within(() => {
                ...
                cy.get(
                  ".PrintPackViewCard_clubbed-parent-divider__DSLtw > .Text_body2__0FftJ"
                )
                  .eq(0)
                  .then(($l1) => {
