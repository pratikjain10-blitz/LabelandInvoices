...
describe("NONduplicateOrderflow", function () {
  ...
  it("Expired Clubbed AWB", function () {
    ...
    cy.get('div[class="PrintPackViewCard_card-border__Qk1I3"]').each(
      ($e1, index, list) => {
        let count;
        cy.get('[class="PrintPackViewCard_card-border__Qk1I3"]')
          .eq(0)
          .within(() => {
            ...
            if (count === 2) {
              cy.get('div[class="PrintPackViewCard_card-border__Qk1I3"]')
                ...
                .within(() => {
                  ...
                  cy.get(" .rs-col-lg-3 > .action-btns-wrapper > .button-link")
                    .eq(0)
                    .click();
                });
              cy.get("@order2")
                ...
                .then(() => {
                  ...
                  cy.get("@order1").then((order1) => {
                    cy.get("@order").then((order) => {
                      ...
                      cy.get(".rs-modal-footer >")
                        .contains("Print Anyways")
                        .click();
                            ...
                            cy.get("@AWB").then((AWB) => {
                              cy.get("@orderid").then((orderid) => {
                                cy.get("@label").then((label) => {
                                  ...
                                  cy.get(
                                    ".rs-col-lg-5.rs-col-md-5 > .Text_body3__jmTqb"
                                  ).click();
                                  cy.get(
                                    'button[class="Button_button-default__NeJ4p button-loading-undefined rs-btn rs-btn-default rs-btn-md"'
                                  ).each(($x1, index, list) => {
                                  ...
                                  cy.get(".rs-input-group-addon").click();
                                  cy.get(
                                    ".rs-flex-box-grid-item-4 > .rs-picker > .rs-picker-toggle"
                                  )
                                    .click()
                                    .then(() => {
                                      cy.get(".rs-radio-checker").each(
                                        ($e1, index, list) => {
                                          if ($e1.text() === "Duplicate") {
                                            cy.get(".rs-radio-wrapper")
                                              .eq(index)
                                              .click();
                                          }
                                        }
              ...
              cy.get('div[class="PrintPackViewCard_card-border__Qk1I3"]')
                ...
                .within(() => {
                  ...
                  //cancel loop starts here
                  cy.get(
                    " :nth-child(2) > .rs-col-lg-3 > .action-btns-wrapper > .button-link"
                  ).click();
                });
              cy.get("@order2")
                .then((order2) => {
                ...
                .then(() => {
                  ...
                  cy.get("@order1").then((order1) => {
                    cy.get("@order").then((order) => {
                      ...
                      cy.get(".rs-modal-footer > .Button_button-ghost__rieSu")
                        .contains("Print All")
                        .click();
