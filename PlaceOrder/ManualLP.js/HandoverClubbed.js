      ...
      cy.get('div[class="HandoverChildViewCard_card__6hKXd"]')
        ...
        .then(($e1) => {
          ...
          cy.get('div[class="HandoverChildViewCard_card__6hKXd"]')
            ...
            .within(() => {
              cy.get(
                ".Flexbox_flex-row__aKbHb > .rs-flex-box-grid-item-8 > :nth-child(2)"
              ).then(($p1) => {
              ...
              cy.get(
                ".Flexbox_flex-row__aKbHb > .rs-flex-box-grid-item-8 > .Text_subtitles-colored__s5ggG"
              ).then(($x1) => {
          ...
          cy.get(
            '.Flexbox_flex-row__aKbHb > .rs-flex-box-grid-item-5 > [data-sd-event="logisticHandOver"]'
          )
            .eq(0)
            .click()
            .then(() => {
              ...
              cy.get(
                ".rs-modal-footer > .Button_button-primary__9i0Rz"
              ).click();
              cy.wait(4000);
