    ...
    { 
      ...
      cy.get('.rs-radio-wrapper').eq(index).click()
          ...
          //cancel loop starts here
            ...
            cy.get('.rs-col-xxl-3 > .action-btns-wrapper > .button-link').then(($v1)=>{
            cy.get('.rs-col-xxl-3 > .action-btns-wrapper > .button-link').eq(0).click()
            cy.wait(2000)
            })
          })
    ...
    //cancel loop starts here
      ...
      cy.log(p)
       ...
       // cy.get('.rs-drawer-actions > .Button_button-primary__9i0Rz').contains('Cancel Order').click()
        ...
        //from here the testing in print starts
          cy.get(':nth-child(1) > .tab').click();
          cy.get(':nth-child(1) > .ButtonGroup_buttongroup-container__Q\+BiA > :nth-child(2)').contains('Clubbed').click()
          cy.wait(7000);
