...
for (let i = 0; i < 3; i++) {
  describe("duplicateOrderflow", function () {
    it("UploadingCatalogueFile", function () {
      ...
      cy.get(
        ":nth-child(8) > :nth-child(2) > .Flexbox_flex-row__aKbHb"
      ).click();
      cy.get(
      ...
      cy.wait(4000);
      cy.xpath(
        "//*[@id='root']/section/section/section/div[2]/div[2]/div/div[2]/div[1]/div[4]/div/div[1]/input"
      )
        .click({ force: true })
        .attachFile("Cataloguecreation.csv");
      cy.wait(5000);
      ...
      cy.get(".rs-modal-content").within(() => {
        cy.get(
          ".Flexbox_flex-row__aKbHb.Flexbox_align-middle__-J0b5.rs-flex-box-grid-center > :nth-child(1)"
        ).type("0000");
        cy.get(".rs-modal-footer > .Button_button-primary__9i0Rz")
          .contains("Verify")
          .click();
      });
      cy.wait(50000);
    ...
    it("PlacementOrderSystemClubbingWebsiteflow", function () {
      ...
      cy.get(".css-1jt1w2w > .css-2f3j1g").click();
      cy.get(".css-2f3j1g").click();
      cy.get(".css-k80332 > .css-1g1oew2 > .css-ha9uku > .css-1aq4tuo")
        .contains("COD")
        .click();
      cy.get(".css-2f3j1g").click();
    ...
    it("DeletingCatalogueAndVerificationofSystemClubbing", function () {
      ...
      cy.get(
        ".TableHeader_card-container-header__rp1eA > :nth-child(4)"
      ).click();
      cy.wait(5000);
      ...
      cy.get(
        ...
        .then(($z1) => {
          ...
          cy.get(
            ".Text_subtitles-colored__s5ggG.Text_cursor-pointer__vwE5X"
          ).then(($s1) => {
          ...
          cy.get("@Awb").then((Awb) => {
            cy.get("@order").then((order) => {
              ...
              cy.get(
                ".rs-col-lg-3 > .action-btns-wrapper > .Button_button-primary__9i0Rz"
              )
                .eq(0)
                .click()
                .then(() => {
