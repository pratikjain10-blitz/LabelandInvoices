    ...
    cy.get(
      ...
      cy.get(
        ...
        .within(() => {
          ...
          cy.get(".rs-col-xl-3.rs-col-lg-4 > :nth-child(4)")
            .then(($e1) => {
            ...
            .then(() => {
              cy.intercept(
                "POST",
                "https://v2.nushop-dashboard.kaip.in/api/order-process/order/invoices"
              ).as("res");
              cy.get(
                ".rs-col-lg-3 > .Flexbox_flex-column__cNkZ2 > .Button_button-ghost__rieSu"
              ).click();
            });
        });
