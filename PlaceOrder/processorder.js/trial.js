    ...
    cy.get('div[class="PrintPackViewCard_card-border__Qk1I3"]').each(
      ($p1, number, $queue) => {
        cy.get('div[class="PrintPackViewCard_card-border__Qk1I3"]')
          ...
          .within(() => {
            cy.get(
              ".PrintPackViewCard_card__Y4Iaa > :nth-child(2) > .rs-col-xl-5 > .Flexbox_flex-row__aKbHb.PrintPackViewCard_product-info__h99UQ > .PrintPackViewCard_product-info__h99UQ > :nth-child(1) > .Text_body2__0FftJ"
            ).then(($v1) => {
